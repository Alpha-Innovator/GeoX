...
from models.geox.mm_utils import get_anyres_image_grid_shape


class GeoXMetaModel:

    def __init__(self, config):
        super(GeoXMetaModel, self).__init__(config)
...
class GeoXMetaForCausalLM(ABC):
    ...
    def initialize_vision_tokenizer(self, model_args, tokenizer):
        ...
        if model_args.mm_use_sep_token:
