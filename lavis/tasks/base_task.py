...
class BaseTask:
    ...
    def build_model(self, cfg):
        ...
        from models.gsformer_pretrain import GSFormerPretrain
        model_cls = GSFormerPretrain
    ...
    def _train_inner_loop(
        ...
        for i in metric_logger.log_every(range(iters_per_epoch), log_freq, header):
            ...
            #             print(f"Parameter {name} is trainable but did not participate in loss computation.")
