...
MODEL_BASE_PATH="${1:-experiments/geox_geometry3k}"
QUESTION_FILE="${2:-data/geometry3k/question.jsonl}"
IMAGE_FOLDER="${3:-data/geometry3k/images}"
...
for MODEL_PATH in "${MODEL_PATHS[@]}"; do
    ...
    python eval/score_geometry3k.py \
        ...
        --gt_file "./data/geometry3k/test.json"
